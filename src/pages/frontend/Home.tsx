      ...
      <div className='lg:flex lg:items-center lg:justify-center lg:mx-auto p-4 mx-2 bg-slate-50'>
        ...
        <div className=" max-w-2xl px-2 py-10 sm:py-10 lg:py-10 lg:ml-16">
          <div className="text-center ">
            ...
            <div className="sm:flex sm:justify-center py-4">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                I'm a MERN stack developer{' '}
                <Link to={'https://www.mongodb.com/mern-stack'} className="font-semibold text-indigo-600">
            ...
            <div className="mt-5 flex items-center justify-center lg:gap-x-4 gap-x-2">
              {/* instagram */}
              <button
                type="button"
                className="inline-block rounded-full p-3 text-xs font-medium uppercase leading-normal bg-gray-700 text-white transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 hover:bg-gray-900 duration-100  shadow-md focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
              >
                <svg
