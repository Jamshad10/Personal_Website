                        ...
                        <div className="w-full lg:w-6/12 sm:w-full px-4 py-4">
                            ...
                            <div className='flex items-center  mt-2'>
                                <svg
                                    ...
                                    className="bg-slate-50 h-5 w-5 mx-1 cursor-pointer transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110  duration-100  shadow-md focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
